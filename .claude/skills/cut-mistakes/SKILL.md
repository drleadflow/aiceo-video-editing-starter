...
node .claude/skills/cut-mistakes/scripts/find-cut-candidates.mjs \
  <silence-transcript.json> --out-dir projects/<slug>/assets
```
...
node .claude/skills/cut-mistakes/scripts/apply-cuts.mjs \
  ...
  --video projects/<slug>/assets/edited-silenced.mp4 \
  --output projects/<slug>/assets/edited-clean.mp4 --apply
```
...
node scripts/build-edl-review.mjs <stem>.mistakes-edl.json \
  --original projects/<slug>/assets/edited-silenced.mp4 \
  --edited   projects/<slug>/assets/edited-clean.mp4 \
  --output   projects/<slug>/assets/mistakes-review.html
npx serve . -p 8080 -n
```
